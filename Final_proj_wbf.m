...
name=sprintf('res_mat_wbf_N%dK%d_%s.mat',N,K,dt)
...
hold off;
legend;
title(['Error-Rate Performance of (' num2str(N) ',' num2str(K) ') WBF Code; AWGN Channel']);
xlabel('Eb/N0 (dB)');
ylabel('Error Rates');
